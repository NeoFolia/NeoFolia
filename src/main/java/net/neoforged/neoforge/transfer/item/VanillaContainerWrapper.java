        ...
        public void updateSnapshots(TransactionContext transaction) {
            ...
            if (container instanceof ChestBlockEntity chest && chest.getBlockState().getValue(ChestBlock.TYPE) != ChestType.SINGLE) {
                ...
                if (chest.getLevel() != null
                        && RegionizedWorldGuard.shouldLoadChunk(chest.getLevel(), otherChestPos.getX() >> 4, otherChestPos.getZ() >> 4)
                        && chest.getLevel().getBlockEntity(otherChestPos) instanceof ChestBlockEntity otherChest) {
