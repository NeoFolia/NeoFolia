...
public abstract class SimpleTicket<T> {
     ...
     */
    @SafeVarargs
    public final synchronized void setManager(ITicketManager<T> masterManager, ITicketManager<T>... dummyManagers) {
     ...
     */
    public synchronized boolean unload(ITicketManager<T> unloadingManager) {
