...
public class ItemHandlerHelper {
    ...
    public static void giveItemToPlayer(Player player, ItemStack stack, int preferredSlot) {
        ...
        if (player instanceof ServerPlayer serverPlayer
                && serverPlayer.level().getServer().regionizedTaskDispatcher().isRunning()
                && !RegionizedWorldGuard.isRegionThreadFor(serverPlayer.level(), serverPlayer.blockPosition())) {
            RegionizedWorldGuard.executeOnPlayerRegion(serverPlayer, () -> giveItemToPlayer(player, stack, preferredSlot));
            return;
        }
